...
for i=1:length(SNR_dB)
    ...
    %Echantilonnage
    t0= Ts;
    ze_avec_bruit = z_avec_bruit(t0:Ts:length(z_avec_bruit));
    %Décisions - détecteur
    seuil = 0;    
    %Décisions - détecteur
...
title("Mapping 1 : TEB théorique et TEB calculé");

figure()
plot(diagramme_oeil_sans_bruit)
title("Diagramme de l'oeil mapping1")
