...
ruleFunction par body env = 
  let typevar = newVariable () in
  let typeres = (type_of_expr body ((par,typevar)::env)) in
  FunctionType(typevar,typeres)
...
ruleCall fct par env =
  ...
  let _, ur = unify typefct (FunctionType(typepar,typevar)) in 
    if ur then 
      typevar
    else 
      ErrorType
...
(* ...............A COMPLETER .......................................*)
ruleRef expr env = 
    ReferenceType (type_of_expr expr env)

and
(* ...............A COMPLETER .......................................*)
ruleRead expr env = 
    let t = type_of_expr expr env in
    match t with
    | ReferenceType (q)-> q
    | _ -> ErrorType
and
...
ruleWrite left right env = 
    match type_of_expr left env with
      |ReferenceType (t) -> let _,ur = unify t (type_of_expr right env) in (if ur then UnitType else ErrorType)
      |_ ->ErrorType 

and
(* ...............A COMPLETER .......................................*)
ruleSequence left right env = 
    let ut, ur = unify (type_of_expr left env) UnitType in 
    if ur then type_of_expr right env else ut
