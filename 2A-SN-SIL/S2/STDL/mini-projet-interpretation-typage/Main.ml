...
let%test _ = ( getValeur (main "../../exemples/exemple-13.mml") = (ReferenceValue "ref@1") )
...
let%test _ = ( getValeur (main "../../exemples/exemple-16.mml") = (IntegerValue 15) )
let%test _ = ( getValeur (main "../../exemples/exemple-18.mml") = (IntegerValue 10) )
let%test _ = ( getValeur (main "../../exemples/exemple-19.mml") = (BooleanValue true) )
let%test _ = ( getValeur (main "../../exemples/exemple-20.mml") = (ErrorValue (UnknownIdentError "a") ) )
...
let%test _ = ( getType (main "../../exemples/exemple-13.mml") = (ReferenceType (IntegerType)) )
...
let%test _ = ( getType (main "../../exemples/exemple-17.mml") = FunctionType(IntegerType,IntegerType))
let%test _ = ( getType (main "../../exemples/exemple-18.mml") = IntegerType )
let%test _ = ( getType (main "../../exemples/exemple-19.mml") = BooleanType )
let%test _ = ( getType (main "../../exemples/exemple-20.mml") = (ErrorType) )
