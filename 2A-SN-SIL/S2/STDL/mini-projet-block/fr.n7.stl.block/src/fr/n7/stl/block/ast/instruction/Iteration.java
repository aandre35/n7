...
public class Iteration implements Instruction {
	...
	public Fragment getCode(TAMFactory _factory) {
		...
		Fragment code = this.condition.getCode(_factory);
		code.addPrefix("etiq_debut_while_" + id);
		
		code.addComment("--------------------------------------------");
		code.addComment("WHILE "+id+" : condition : " + condition);
		code.addComment("--------------------------------------------");

		//JumpIf vers la fin
		code.add(_factory.createJumpIf("etiq_fin_while_"+id, 0));
		
		// On ajoute le code du body
		code.append(this.body.getCode(_factory));

		// Jump vers le début de la boucle
		code.add(_factory.createJump("etiq_debut_while_"+id));
		
		// Label de fin
		code.addSuffix("etiq_fin_while_" + id);
		return code;
	}
