...
public class Return implements Instruction {
	...
	public Fragment getCode(TAMFactory _factory) {
		Fragment code = this.value.getCode(_factory);
		code.add(_factory.createReturn(this.value.getType().length(), this.offset));
		code.addComment("--------------------------------------------");
		String _comment = "Return : return " + this.value.toString();
