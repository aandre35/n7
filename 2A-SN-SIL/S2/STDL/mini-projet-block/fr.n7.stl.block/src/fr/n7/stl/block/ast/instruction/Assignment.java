...
public class Assignment implements Instruction, Expression {
	...
	public boolean completeResolve(HierarchicalScope<Declaration> _scope) {
		return this.value.completeResolve(_scope) && this.assignable.completeResolve(_scope);
	}
	...
	public boolean checkType() {
		if (this.value.getType().compatibleWith(this.assignable.getType())) {
			...
			Logger.error("les types ne correspondent pas. Type de la valeur : " + this.value.getType().toString() + ", Type de l'assignable : " + this.assignable.getType().toString() + ".");
			return false;
		}
	}
